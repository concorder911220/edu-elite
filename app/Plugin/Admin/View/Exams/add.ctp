<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#end_date').datetimepicker({
            locale: '<?php echo $configLanguage;?>', format: '<?php echo $dpFormat;?> HH:mm', useCurrent: false //Important! See issue #1075
        });
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#showExam').hide();
        $('#paidExam').hide();
        $('#ExamTypePreparation').click(function () {
            $('#showExam').show();
        });
    ...
    function showSubject() {
        ...
        $('#showdetails').append('<div class="col-sm-12"><div id=sub' + $('#subjectId').val() + '><div><label for="group_name" class="col-sm-2 control-label"><small>' + subject_name + '</small></lable></div>' +
            ...
            '<div class="col-sm-2"><button type="button" class="btn btn-danger" onclick="delItem(' + $('#subjectId').val() + ');">' + getLocale('Remove') + '</button></div>' +
            '</div>');
        $('#subjectId').val('');
        $('#quesNo').val('');
        $('#type').val('');
...
<div class="page-title">
    <div class="title-env"><h1 class="title"><?php echo __('Add Exam'); ?></h1></div>
</div>
<div class="panel">
    <div class="panel">
        ...
        <div class="panel-body"><?php echo $this->Session->flash(); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo $this->Form->select('ExamsPackage.package_id', $package, array('multiple' => true, 'label' => false, 'class' => 'form-control multiselectgrp', 'div' => false)); ?>
                </div>
            </div>
            <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Name of Exam'); ?></small>
                </label>
                <div class="col-sm-4">
                    <?php echo $this->Form->input('name', array('label' => false, 'class' => 'form-control', 'placeholder' => __('Name of Exam'), 'div' => false)); ?>
                </div>
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Passing Percentage'); ?></small>
                </label>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Instruction'); ?></small>
                </label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Syllabus'); ?></small>
                </label>
                <div class="col-sm-10">
                    <?php echo $this->Tinymce->input('syllabus', array('label' => false, 'class' => 'form-control', 'div' => false, 'placeholder' => __('syllabus')), array('language' => $configLanguage, 'directionality' => $dirType), 'full'); ?>
                </div>
            </div>
            <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Exam Duration (Min.)'); ?></small>
                </label>
                <div class="col-sm-4">
                    <?php echo $this->Form->input('duration', array('label' => false, 'class' => 'form-control', 'placeholder' => __('0 for unlimited duration'), 'div' => false)); ?>
                </div>
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Attempt Count'); ?></small>
                </label>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Show Answer Sheet'); ?></small>
                </label>
                <div class="col-sm-4">
                    <?php echo $this->Form->input('declare_result', array('type' => 'radio', 'options' => array("Yes" => __('Yes'), "No" => __('No')), 'default' => 'Yes', 'legend' => false, 'before' => '<label class="radio-inline">', 'separator' => '</label><label class="radio-inline">', 'after' => '</label>', 'label' => false, 'div' => false)); ?>
                </div>
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Select Group'); ?></small>
                </label>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Negative Marking'); ?></small>
                </label>
                <div class="col-sm-4">
                ...
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Random Question'); ?></small>
                </label>
                <div class="col-sm-4">
            ...
            <?php if ($frontExamPaid > 0) { ?>
                <div class="form-group">
                    <label for="group_name" class="col-sm-2 control-label">
                        <small><?php echo __('Paid Exam'); ?></small>
                    </label>
                    <div class="col-sm-4">
            ...
            <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Browser Tolerance'); ?></small>
                </label>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Result After Finish'); ?></small>
                </label>
                <div class="col-sm-4">
                    <?php echo $this->Form->input('finish_result', array('type' => 'radio', 'options' => array("1" => __('Yes'), "0" => __('No')), 'default' => '1', 'legend' => false, 'before' => '<label class="radio-inline">', 'separator' => '</label><label class="radio-inline">', 'after' => '</label>', 'label' => false, 'div' => false)); ?>
                </div>
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Mode'); ?></small>
                </label>
                <div class="col-sm-4">
                    <?php echo $this->Form->input('type', array('type' => 'radio', 'options' => array("Exam" => __('Exam'), "Preparation" => __('Preparation')), 'default' => 'Exam', 'legend' => false, 'before' => '<label class="radio-inline">', 'separator' => '</label><label class="radio-inline">', 'after' => '</label>', 'label' => false, 'div' => false)); ?>
                </div>
            </div>
            <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Instant Result'); ?></small>
                </label>
                <div class="col-sm-4">
                ...
                <label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Option Shuffle'); ?></small>
                </label>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo $this->Form->input('multi_language', array('type' => 'radio', 'options' => array("1" => __('Yes'), "0" => __('No')), 'default' => '0', 'legend' => false, 'before' => '<label class="radio-inline">', 'separator' => '</label><label class="radio-inline">', 'after' => '</label>', 'label' => false, 'div' => false)); ?>
                </div>
				<label for="group_name" class="col-sm-2 control-label">
                    <small><?php echo __('Math Editor'); ?></small>
                </label>
                <div class="col-sm-4">
                    <?php echo $this->Form->input('math_edit_type', array('type' => 'radio', 'options' => array("1" => __('Yes'), "0" => __('No')), 'default' => '0', 'legend' => false, 'before' => '<label class="radio-inline">', 'separator' => '</label><label class="radio-inline">', 'after' => '</label>', 'label' => false, 'div' => false)); ?>
                </div>
            </div>
            <div id="showExam">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#subjectModal"><?php echo __('Add Subjects To Exams'); ?></button>
                    </div>
                    <div class="col-sm-2">
                    </div>
                </div>
                <div class="form-group">
                    <div><label for="group_name" class="col-sm-2 control-label">
                            <small><?php echo __('Subject Name'); ?></small>
                        </label></div>
                    <div><label for="group_name" class="col-sm-2 control-label">
                            <small><?php echo __('No. of Questions'); ?></small>
                        </label></div>
                    <div><label for="group_name" class="col-sm-2 control-label">
                ...
                <div class="modal-body">
                    <form name="modalForm" id="modalForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php echo $this->Form->select('subject_id', $subjectId, array('id' => 'subjectId', 'empty' => __('Please Select Subject'), 'label' => false, 'class' => 'form-control validate[required]', 'div' => false)); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="group_name" class="col-sm-4 control-label"><?php echo __('No. of Questions'); ?>
                                :</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label for="group_name" class="col-sm-4 control-label"><?php echo __('Question Type'); ?>
                                :</label>
                            <div class="col-sm-8">
                                <?php echo $this->Form->select('type', $quesType, array('id' => 'type', 'multiple' => true, 'default' => array(1, 2, 3, 4), 'label' => false, 'class' => 'form-control', 'div' => false)); ?>
                                <span><?php echo __('ctrl+click to add multiples'); ?></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="group_name" class="col-sm-4 control-label"><?php echo __('Difficulty Level'); ?>
                                :</label>
                            <div class="col-sm-8">
                                <?php echo $this->Form->select('level', $diffLevel, array('id' => 'level', 'multiple' => true, 'default' => array(1, 2, 3), 'label' => false, 'class' => 'form-control', 'div' => false)); ?>
                                <span><?php echo __('ctrl+click to add multiples'); ?></span>
                            </div>
                        </div>
                        <?php echo $this->Form->end(); ?>
