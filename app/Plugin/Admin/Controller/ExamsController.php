...
class ExamsController extends AdminAppController
{
	...
	public function index()
	{
		try {
			...
			$this->Paginator->settings['fields'] = array('Exam.id', 'Exam.name', 'Exam.start_date', 'Exam.end_date', 'Exam.type', 'Exam.status');
			$this->Paginator->settings['group'] = array('Exam.id', 'Exam.name', 'Exam.start_date', 'Exam.end_date', 'Exam.type', 'Exam.status');
