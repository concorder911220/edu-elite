...
$(document).ready(function () {
	...
	// 	allSelectedText: getLocale("All Selected"),
	// 	filterPlaceholder: getLocale("Search"),
	// 	nonSelectedText: getLocale("None selected"),
	// 	selectAllText: getLocale("Select All"),
...
function check_perform_delete() {
	...
	if (numberOfChecked == 0) alert(getLocale("Please Select Any Record"));
	else {
		if (
			confirm(
				getLocale("Do You Want To Delete") +
					" " +
					numberOfChecked +
					" " +
					getLocale("Record")
