...
//This function is used to get IE Version else return -1
...
if(inBox.val().indexOf("Infinity")>-1 || inBox.val().indexOf(strMathError)>-1) return ; 
        switch (this.id) {
			...
			case 'keyPad_EXP':stackCheck("e+0");
	...
	if(inBox.val().indexOf("Infinity")>-1 || inBox.val().indexOf(strMathError)>-1) return ; 
	 switch (this.id) {
	  case 'keyPad_MS':memory=x; $("#memory").addClass("memoryshow"); $("#memory").removeClass("memoryhide");retVal=inBox.val(); //stackVal1 =2;
	  break;
	 case 'keyPad_M+':memory=x+parseFloat(memory);$("#memory").addClass("memoryshow");$("#memory").removeClass("memoryhide");retVal=inBox.val(); //stackVal1 =2;
	 break;
	 case 'keyPad_MR':retVal=parseFloat(memory);
	                        stackVal1=1;
	                     break;							
	 case 'keyPad_MC':memory=0; $("#memory").removeClass("memoryshow");$("#memory").addClass("memoryhide");
	                  retVal=inBox.val(); //stackVal1 =2;
	                      break;
	 case 'keyPad_M-':$("#memory").addClass("memoryshow");$("#memory").removeClass("memoryhide");                   
	...
	if(inBox.val().indexOf("Infinity")>-1 || inBox.val().indexOf(strMathError)>-1) return ; 
        switch (this.id) {
            ...
            //10^x
            case 'keyPad_btn10X': retVal = Math.pow(10, x); 
    ...
    //if((count>1)||(((inBox1.val().indexOf("+")>-1)&&(inBox1.val().indexOf("e")>-1))&&(inBox1.val().indexOf("e")>inBox1.val().indexOf("+")))||(((inBox1.val().indexOf("-")>-1)&&(inBox1.val().indexOf("e")>-1))&&(inBox1.val().indexOf("e")>inBox1.val().indexOf("-")))||(((inBox1.val().indexOf("/")>-1)&&(inBox1.val().indexOf("e")>-1))&&(inBox1.val().indexOf("e")>inBox1.val().indexOf("/")))||(((inBox1.val().indexOf("*")>-1)&&(inBox1.val().indexOf("e")>-1))&&(inBox1.val().indexOf("e")>inBox1.val().indexOf("*"))))
	  ...
	  /*  {
        ...
        switch (this.id) {
            ...
            case 'keyPad_btnBack': if(stackVal1 ==1 || stackVal2 == 3){if (strInput.length > 1) {	if(inBox.val().indexOf("Infinity")>-1 || inBox.val().indexOf(strMathError)>-1) return ; 
