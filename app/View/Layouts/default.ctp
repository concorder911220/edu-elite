					...
					<div class="container">
						...
						<div class="main-menu-wrapper">
							...
							<ul id="frontMenu" class="main-nav">
								<li class="active"><a href="<?= $siteDomain ?>"><i class="fa fa-home"></i>&nbsp;Home</a>
								</li>
								<li class="has-submenu menu-effect">
									<a href="#"><i class="fa fa-globe"></i>&nbsp;About&nbsp;<i
											class="fas fa-chevron-down"></i></a>
									<ul class="submenu">
										<li><a href="<?= $siteDomain ?>/Contents/Pages/About-Us"><i class=""></i>&nbsp;About
												Us</a>
										</li>
										<li><a href="<?= $siteDomain ?>/Contents/Pages/Profile"><i class=""></i>&nbsp;Profile</a>
										</li>
									</ul>
								</li>
								<li><a href="<?= $siteDomain ?>/Packages/index/index"><i
											class="fa fa-shopping-cart"></i>&nbsp;Packages</a></li>
								<li><a href="<?= $siteDomain ?>/Registers/index"><i class="fa fa-user"></i>&nbsp;Register</a>
								</li>
								<li><a href="<?= $siteDomain ?>/Schedules/index"><i
											class="fa fa-calendar"></i>&nbsp;Schedules</a>
								</li>
								<li><a href="<?= $siteDomain ?>/crm/Users/login"><i class="fa fa-lock"></i>&nbsp;Login</a></li>
							</ul>
						</div>
						<ul class="nav header-navbar-rht">
							<li class="nav-item cart-nav">
								<a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" id="products_animation_id">
											...
											<ul id="products_animation"
												...
												<div class="divproducts_animation w-100" bis_skin_checked="1">
													<?php foreach ($products_animation as $product_animation): ?>
														...
														?>
														<li class="ani_li row">
															<div class="col-md-2 col-xs-2 product_animation_img" bis_skin_checked="1">
												...
												<li class="ani_li row" style="border-top: 1px solid #000;">
													<div class="col-md-9" bis_skin_checked="1"><span class="textblack"><strong>TOTAL
																PRICE</strong></span>
													</div>
													<div class="col-md-3 p0" style="text-align: right;" bis_skin_checked="1">
														<span class="textblack"><strong><?php echo "$" . $total; ?></strong></span>
													</div>
													<div style="clear: both;" bis_skin_checked="1"></div>
												</li>
										...
										<?php else: ?>
											<ul>
												<div class="empty-cart textblack mb-4">
													<center>
														<a class="cartbag" href="/Carts/View"><i class="fa fa-shopping-bag"></i></a>
														<br><br>
							...
							<li class="nav-item">
								<a href="<?= $siteDomain ?>/crm/Users/login" class="nav-link header-sign">Signin</a>
							</li>
							<li class="nav-item">
								<a href="<?= $siteDomain ?>/Registers/index" class="nav-link header-login">Signup</a>
							</li>
						</ul>
					</div>
				</nav>
