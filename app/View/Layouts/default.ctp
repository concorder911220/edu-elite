					...
					<ul class="nav header-navbar-rht">
						<div class="dropdown nav-item cart-nav">
							...
							<div class="wishes-list dropdown-menu dropdown-menu-right"
								aria-labelledby="products_animation_id">
					...
					<div class="col-lg-2 col-md-6 footer-links">
						...
						<ul>
							<li><i class="bx bx-chevron-right"></i><a
									href="<?= $siteDomain ?>/Contents/Pages/Profile">Profile</a></li>
							<li><i class="bx bx-chevron-right"></i><a
									href="<?= $siteDomain ?>/admin/Users/login_form">Login</a></li>
					...
					<div class="col-lg-3 col-md-6 footer-links">
						...
						<ul>
							...
							<li><i class="bx bx-chevron-right"></i> <a
									href="<?= $siteDomain ?>/Contents/Pages/Profile">Profile</a></li>
							<li><i class="bx bx-chevron-right"></i> <a
									href="<?= $siteDomain ?>/crm/Users/login#">Login</a></li>
							<li><i class="bx bx-chevron-right"></i> <a
									href="<?= $siteDomain ?>/Registers/index#">Register</a></li>
						</ul>
					</div>
