            ...
            if (a.indexOf('^') > -1) {
                ...
                if (response_msg[1].length > 0) {
                    ...
                    if (response_msg[1] <= 0) {
                        $('#proceed_to_pay').hide();
                        $('#make_payment').hide();
                        $('#cart').html('<table id="cart" class="table table-hover table-condensed" style="margin:0px"><tbody><tr><td class="center"><div class=""><?php echo $this->Html->link(__("Free Checkout"), array("controller" => "checkouts", "action" => "paymentGateway", "FREE"), array("class" => "btn btn-lg btn-success", "escape" => false)); ?></div></td></tr></table>');
                    }
                }
					...
					<div class="col-sm-4 p0">
						<div class="panel-heading">
							<div class="widget view-cart">
								<a href="<?php echo $this->Html->url(array('controller' => 'Carts', 'action' => 'View')); ?>"><?php echo __('VIEW CART'); ?></a>
							</div>
						</div>
					</div>
					<div class="col-sm-4 p0">
						...
						<div id="review_order">
											...
											<div class="row">
												...
												<div class="col-sm-9 col-xs-12">
													...
													<div style="height: 150px;overflow-y: scroll;">
														<p align="justify"><?php echo $product['Package']['description']; ?></p>
													</div>
												</div>
											</div>
										</td>
							...
							<div class="checkout-proceed row">
								<div class="col-sm-6 col-xs-12 edit-cart-btn">
									<a href="<?php echo $this->html->url(array('controller' => 'Carts', 'action' => 'View')); ?>"><?php echo __('EDIT CART'); ?></a>
								</div>
						...
						<table id="cart" class="table table-hover table-condensed" style="margin:0px">
							...
							<?php if ($products) { ?>
								...
								<?php if ($totalAmount == 0) { ?>
									<td class="center">
										<div
											class=""><?php echo $this->Html->link(__('Free Checkout'), array('controller' => 'checkouts', 'action' => 'paymentGateway', 'FREE'), array('class' => 'btn btn-lg btn-success', 'escape' => false)); ?></div>
									</td>
								<?php } else { ?>
									<?php if ($CAE == true) { ?>
										<td class="center">
											<div
												class=""><?php echo $this->Html->link($this->Html->image('ccavenue.png'), array('controller' => 'checkouts', 'action' => 'paymentGateway', 'CCAVENUE'), array('class' => 'img-thumbnail', 'escape' => false, 'id' => 'ccavenue')); ?></div>
										</td>
									<?php } ?>
									...
									<?php if ($PME == true) { ?>
										<td class="center">
											<div
												class=""><?php echo $this->Html->link($this->Html->image('payumoney.png'), array('controller' => 'checkouts', 'action' => 'paymentGateway', 'PAYUMONEY'), array('class' => 'img-thumbnail', 'escape' => false, 'id' => 'payu')); ?></div>
										</td>
									<?php } ?>
									...
									<?php if ($PPL == true) { ?>
										<td class="center">
											<div
												class=""><?php echo $this->Html->link($this->Html->image('paypal.png'), array('controller' => 'checkouts', 'action' => 'paymentGateway', 'PAYPAL'), array('class' => 'img-thumbnail', 'escape' => false,'id'=>'paypal')); ?></div>
										</td>
									<?php } ?>
					...
					<div class="cart-summerymain">
						...
						<?php if ($totalAmount >= 0) { ?>
							<div class="cart-summary">
								...
								<div class=""
									 style="font-weight: normal;"><?php echo __('Prices are inclusive of all taxes'); ?></div>
							</div>
							<div style="clear: both;"></div>
						<?php } ?>
					</div>
