    ...
    <div class="panel-body">
        <div class="">
            <table class="table table-striped">
                ...
                ?>
                    <tr>
                        <td><?php echo $this->Html->image($post['student_photo'], array('title'=>$post['student_name'], 'alt'=>$post['student_name'], 'class'=>'img-responsive img-circle img-thumbnail','style'=>'height:50px;'));?></td>
