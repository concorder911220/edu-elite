...
<a href="<?php echo $this->Html->url(array('controller' => 'Packages', 'action' => 'index')) ?>"
   class="back-page position-static"><i class="fa fa-chevron-left"
						aria-hidden="true"></i> <?php echo __('Back to Packages'); ?></a>
</span>
		</div>
		</div>
				...
				<div class="col-md-6 summery-block">
					<div class="mycontainer">
						...
						<div class="product-price">
							...
							<?php }?>
							<span
								class="text-success"><big><strong> <?php if ($post['Package']['package_type'] != 'F') {
    ...
    if ($post['Package']['id'] != $Package_id) {
        ?>
            ...
            $photo1 = "nia.png";
											...
											<span
												class="text-info"><?php echo $Packagesvalue['Package']['name']; ?></span>
										</a>
									</div>
								</li>
								<?php
