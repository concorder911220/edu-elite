...
<div class="col-md-9 col-sm-offset-2">
	<div class="panel panel-default">
		<div class="panel-heading">
			<strong><?php echo __('Instructions') . ' ' . __('of') . ' ' . h($post['Exam']['name']); ?></strong></div>
		<div class="panel-body">
			...
			<p><?php echo $this->Form->button(__('Exam Start'), array('id' => 'submitaccept', 'disabled' => 'disabled', 'class' => 'btn btn-success')); ?></p>
