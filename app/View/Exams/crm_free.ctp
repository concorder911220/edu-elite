...
<div class="panel">
	<div class="panel-heading">
		<div class="btn-group">
			<?php echo $this->Html->link(__("Free Exam"), array('controller' => 'Exams', 'action' => 'free'), array('class' => 'btn btn-success btn-selected btn-exam-name')); ?>
	...
	<?php if ($mainExam) { ?>
		<div style="margin-left:2rem"><?php echo __('These are the free exam(s) that can be taken right now'); ?></div>
