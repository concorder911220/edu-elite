...
<div class="panel">
    <div class="panel-heading">
        <div class="btn-group">
			...
			<?php echo$this->Html->link(__('Expired Exam'),array('controller'=>'Exams','action'=>'expired'),array('class'=>'btn btn-success btn-selected btn-exam-name'));?>
		</div>
    </div>
	...
	<?php if ($mainExam) { ?>
		<div style="margin-left:2rem"><?php echo __('These are the exam(s) which has been expired'); ?></div>
