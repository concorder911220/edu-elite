               ...
               <div class="row ">
                  ...
                  <div class="col-md-5 d-flex align-items-center">
                     <div class="girl-slide-img aos" data-aos="fade-up">
                        <img src="<?php echo $this->webroot; ?>img/tab/<?php echo $Homesection[0]['Homesection']['sections_img'] ?>" alt="">
                     </div>
                  </div>
               </div>
            </div>
                                ...
                                <div class="trending-three-item">
                                    <div class="trending-content-top trending-bg-one">
                                        ...
                                        <div class="trending-three-text">
                                            <a href="#">
                                                <h3 class="title instructor-text"><?php echo $exam_lists[$key]["Exam"]["instruction"]; ?></h3>
...
<p class="mb-0"><?php echo __($Homesection[1]['Homesection']['sections_content']) ?>
    ...
    ?>
																							                        ...
																							                        <div class="product trend-product">
																							                           ...
																							                           <a class="" href="<?php echo $this->Html->url(array('controller' => 'Packages', 'action' => 'singleproduct', $id, Inflector::slug(strtolower($package_lists[$key]["Package"]["name"]), "-"))) ?>">
																							                                       <?php echo $this->Html->image($photo, array('alt' => h($package_lists[$key]["Package"]["name"]), 'class' => '
								                           ...
								                           <div class="product-content">
								                              <div class="course-group d-flex">
								                                 <div class="course-group-img d-flex">
								                                    <a href="<?php echo $this->Html->url(array('controller' => 'Packages', 'action' => 'singleproduct', $id, Inflector::slug(strtolower($package_lists[$key]["Package"]["name"]), "-"))) ?>"><img src="app/webroot/img/v2/user.png" alt="" class="img-fluid"></a>
								                                    <div class="course-name">
								                                       <h4><a href="<?php echo $this->Html->url(array('controller' => 'Packages', 'action' => 'singleproduct', $id, Inflector::slug(strtolower($package_lists[$key]["Package"]["name"]), "-"))) ?>"><?php echo $package_lists[$key]["Package"]["name"]; ?></a></h4>
								                                       <!-- <p><?php echo $package_lists[$key]["Package"]["amount"]; ?></p> -->
								                                    </div>
								                                 </div>
								                              </div>
								                              <h3 class="title"><a href="<?php echo $this->Html->url(array('controller' => 'Packages', 'action' => 'singleproduct', $id, Inflector::slug(strtolower($package_lists[$key]["Package"]["name"]), "-"))) ?>"><?php echo $package_lists[$key]["Package"]["description"]; ?></a>
								                              </h3>
								                              <div class="course-info d-flex align-items-center">
								                                 <div class="rating-img d-flex align-items-center">
								                                    <p><b>Project Type:</b> <?php echo ($package_lists[$key]["Package"]["package_type"] == "P" ? "Paid" : "Free"); ?></p>
								                                 </div>
								                                 <div class="course-view d-flex align-items-center">
								                                    <p><b>Expired Days:</b> <?php echo $package_lists[$key]["Package"]["expiry_days"] ? $package_lists[$key]["Package"]["expiry_days"] : 0; ?></p>
								                                 </div>
								                              </div>
								                           </div>
								                        </div>
                     ...
                     <div class="col-xl-8 col-lg-10 col-md-10 mx-auto" data-aos="fade-down">
                        <div class="testimonial-inner">
                           <div class="header-two-title testimonial-head-two text-center">
                              <h2 data-aos="fade-down"><?php echo __($Homesection[4]['Homesection']['sections_heading']); ?></h2>
                  ...
                  <div class="latest-blog-main">
                     ...
                     <?php if (count($news) > 0): ?>
                        <?php foreach ($news as $key => $new): ?>
                            <div class="col-xl-6 col-lg-12 col-md-12" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $news[$key]["News"]["id"]; ?>">
                                <div class="row">
                                    <div class="col-md-12">
                            ...
                            <!-- Modal -->
                           <div class="modal fade" id="exampleModal<?php echo $news[$key]["News"]["id"]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel"><?php echo $news[$key]["News"]["news_title"]; ?></h5>
