<div class="header-content text-center"><h1><?php echo __('Re-Send Email/Mobile Verification'); ?></h1></div>
...
<div class="body-content">
    ...
    <div class="form-group">
        <p>
            <?php echo $this->Html->link(__('Click here to login'), array('controller' => 'Registers', 'action' => 'index'), array('id' => 'btn-register', 'class' => 'btn-link', 'escape' => false)); ?>
        </p>
    </div>
</div>
