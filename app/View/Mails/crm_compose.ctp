...
<div class="panel">
    <div class="panel-body">
        <?php echo $this->Form->create('Mail', array('url' => array('controller' => 'Mails', 'action' => 'compose'), 'name' => 'post_req', 'id' => 'post_req', 'class' => 'form-horizontal')); ?>
        <div class="form-group">
            <label for="group_name" class="col-sm-3 control-label">
                <small><?php echo __('To'); ?></small>
            </label>
            <div class="col-sm-9">
                <?php echo $this->Form->input('to_email', array('label' => false, 'class' => 'form-control', 'value' => $mainUserName, 'div' => false, 'readonly' => 'readonly')); ?>
            </div>
        </div>
        <div class="form-group">
            <label for="group_name" class="col-sm-3 control-label">
        ...
        <div class="form-group text-left">
            <div class="col-sm-offset-3 col-sm-7">
                <button type="submit" class="btn btn-success"><span class="fa fa-send"></span><?php echo __('Send'); ?>
                </button>
