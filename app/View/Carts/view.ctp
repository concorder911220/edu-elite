						...
						<div class="col-sm-12">
							<div class="empty-cart cart-rmpty-pages">
								<center>
									...
									<br>
									<span
										class="text-uppercase empty-msg"><?php echo __('your cart is empty'); ?></span>
            ...
            ?>
											<li class="cus-slider-item">
												<div class="col-md-12 cus-slider-item-inner">
													<a href="<?php echo $this->Html->url(array('controller' => 'Packages', 'action' => 'singleproduct', $Package_id, Inflector::slug(strtolower($Packagesvalue['Package']['name']), "-"))) ?>">
    ...
    $totalQuantity = 0;?>
														...
														<div class="cart-item-price">
															<strong style="font-size:17px;">
																...
																<?php if ($product['Package']['show_amount'] != $product['Package']['amount']) {?>
																	<strike>
																		<span
																			style="font-weight: normal;"> <?php echo "$" . $product['Package']['show_amount']; ?></span>
																	</strike>
																<?php }?> <?php echo "$" . $product['Package']['count'] * $product['Package']['amount']; ?>
															</strong>
														</div>
        ...
        $totalQuantity = $totalQuantity + $product['Package']['count'];?>
							...
							<tr class="cart-total-amount">
								<td align="right">
									<h3 class="total-amount"><?php echo __('Total'); ?>: <?php echo "$" . $total ?></h3></td>
							</tr>
